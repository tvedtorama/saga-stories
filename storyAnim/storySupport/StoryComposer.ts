...
export class StoryComposer<
			...
			TSeg extends {validFunc: () => ((s: StoryAnim.IEventState) => boolean), meta: () => {
				/** Starting position, as percent of total */
				startPos: number
			}}> {
	...
	/** Returns the meta data for all segments, with start pos in percent of total */
	getSegmentMetas() {
